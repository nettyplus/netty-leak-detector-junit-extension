...
- Apache Flink [NettyLeakDetectionExtension](https://github.com/apache/flink/blob/master/flink-runtime/src/test/java/org/apache/flink/runtime/io/network/netty/NettyLeakDetectionExtension.java) - Flink's internal leak detection for tests
